...
class InsertPosts extends AbstractMigration {
    ...
    public function up() {
        ...
        $this->execute("INSERT INTO posts (id, member_id, title, published, created, modified) VALUES"
                ...
                . "(1819, 999, '「欅坂46ミニ握手会～12/20 富士見、港北」レポート', '2015-12-20 00:00:00', now(), now()),"
                . "(1818, 999, '「欅坂46ミニ握手会～12/19 豊洲、昭島、東大和」レポート', '2015-12-19 00:00:00', now(), now())"
                . "");
    }

    public function down() {
        parent::down();
        $this->execute("DELETE FROM posts WHERE id IN (2539, 2522, 2218, 1822, 1821, 1820, 1819, 1818)");
    }
